...
module BingAdsApi
	...
	class CustomerManagement < BingAdsApi::Service
		...
		def get_accounts_info(customer_id=nil, only_parent_accounts=false)
			...
			accounts = [response_hash[:accounts_info][:account_info]].flatten.map do |account_hash|
		...
		def get_customers_info
			call(:get_customers_info, { application_scope: "Advertiser", customer_name_filetr: "", top_n: 100 })
